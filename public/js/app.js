...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_Home__ = __webpack_require__(39);
...
/* harmony default export */ __webpack_exports__["a"] = new __WEBPACK_IMPORTED_MODULE_1_vue_router___default.a({
  routes: [
    { path: '/', name: 'Home', component: __WEBPACK_IMPORTED_MODULE_2__views_Home___default.a },
    { path: '/search', component: __webpack_require__(40) }
  ]
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__types__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api__ = __webpack_require__(50);
...
const mutations = {
  [__WEBPACK_IMPORTED_MODULE_2__types__["b" /* CLEAN_UP */]] (state, payload) {
    state.tags = []
    state.model = {}
  },
  [__WEBPACK_IMPORTED_MODULE_2__types__["c" /* SET_TAGS */]] (state, payload) {
    state.tags = payload
  },
  [__WEBPACK_IMPORTED_MODULE_2__types__["e" /* SET_MODEL */]] (state, payload) {
    state.model = payload.model
  },
  [__WEBPACK_IMPORTED_MODULE_2__types__["a" /* LOADING_BEGIN */]] (state) {
    state.loading = true
  },
  [__WEBPACK_IMPORTED_MODULE_2__types__["d" /* LOADING_END */]] (state) {
    state.loading = false
  },
  [__WEBPACK_IMPORTED_MODULE_2__types__["f" /* PROCESS_BEGIN */]] (state) {
    state.processing = true
  },
  [__WEBPACK_IMPORTED_MODULE_2__types__["g" /* PROCESS_END */]] (state) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_multiselect__ = __webpack_require__(43);
...
/* harmony default export */ __webpack_exports__["default"] = {
  ...
  methods: {
    ...
    load: function load() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://localhost:3000/api/search', params).then(function (response) {
    ...
    download: function download() {
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://localhost:3000/api/download', this.selected).then(function (response) {
...
var update = __webpack_require__(12)("399cadc6", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(12)("0d46fa97", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
function getTags (path, success, fail) {
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(`http://localhost:3000/api/${path}`)
...
function search (payload, success, fail) {
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(`http://localhost:3000/api/${payload.path}`, payload.values)
    .then(function (response) {
      success(response.data)
    })
    .catch(function (error) {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LOADING_BEGIN;

const LOADING_END = 'LOADING_END'
/* harmony export (immutable) */ __webpack_exports__["d"] = LOADING_END;

const SET_TAGS = 'SET_TAGS'
/* harmony export (immutable) */ __webpack_exports__["c"] = SET_TAGS;

const SET_MODEL = 'SET_MODEL'
/* harmony export (immutable) */ __webpack_exports__["e"] = SET_MODEL;

const PROCESS_BEGIN = 'PROCESS_BEGIN'
/* harmony export (immutable) */ __webpack_exports__["f"] = PROCESS_BEGIN;

const PROCESS_END = 'PROCESS_END'
/* harmony export (immutable) */ __webpack_exports__["g"] = PROCESS_END;

const REDIRECT = 'REDIRECT'
/* unused harmony export REDIRECT */

const CLEAN_UP = 'CLEAN_UP'
/* harmony export (immutable) */ __webpack_exports__["b"] = CLEAN_UP;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex_router_sync__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__views_App__ = __webpack_require__(13);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("\n                    Download\n                    "), (_vm.selected.length) ? _c('span', [_vm._v(_vm._s(_vm.selected.length))]) : _vm._e()])])])])])])])
